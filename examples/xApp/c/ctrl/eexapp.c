...
// RRM_Policy_Ratio_List (gen_rrm_policy_ratio_list)
// └── RRM_Policy_Ratio_Group (gen_rrm_policy_ratio_group)
//    ├── RRM_Policy
                                ...
                                int c_t)  
{
  ...
  A_T_Param->ran_param_val.type = ELEMENT_KEY_FLAG_FALSE_RAN_PARAMETER_VAL_TYPE;
  A_T_Param->ran_param_val.flag_false = calloc(1, sizeof(ran_parameter_value_t));
  assert(A_T_Param->ran_param_val.flag_false != NULL && "Memory exhausted");
  A_T_Param->ran_param_val.flag_false->type = INTEGER_RAN_PARAMETER_VALUE;
  A_T_Param->ran_param_val.flag_false->int_ran = a_t;

  // b_t - Minimal PRB allocation duration
  seq_ran_param_t* B_T_Param = &RRM_Policy_Ratio_Group->ran_param_struct.ran_param_struct[5];
  B_T_Param->ran_param_id = Minimal_PRB_Allocation_Duration_8_4_3_6;
  B_T_Param->ran_param_val.type = ELEMENT_KEY_FLAG_FALSE_RAN_PARAMETER_VAL_TYPE;
  B_T_Param->ran_param_val.flag_false = calloc(1, sizeof(ran_parameter_value_t));
  assert(B_T_Param->ran_param_val.flag_false != NULL && "Memory exhausted");
  B_T_Param->ran_param_val.flag_false->type = INTEGER_RAN_PARAMETER_VALUE;
  B_T_Param->ran_param_val.flag_false->int_ran = b_t;

  // c_t - Second normal PRB allocation duration
  seq_ran_param_t* C_T_Param = &RRM_Policy_Ratio_Group->ran_param_struct.ran_param_struct[6];
  C_T_Param->ran_param_id = Second_Normal_PRB_Allocation_Duration_8_4_3_6;
  C_T_Param->ran_param_val.type = ELEMENT_KEY_FLAG_FALSE_RAN_PARAMETER_VAL_TYPE;
  C_T_Param->ran_param_val.flag_false = calloc(1, sizeof(ran_parameter_value_t));
  assert(C_T_Param->ran_param_val.flag_false != NULL && "Memory exhausted");
  C_T_Param->ran_param_val.flag_false->type = INTEGER_RAN_PARAMETER_VALUE;
  C_T_Param->ran_param_val.flag_false->int_ran = c_t;
...
void gen_rrm_policy_ratio_list(seq_ran_param_t* RRM_Policy_Ratio_List)
{
  ...
  // Generate policy for each slice
